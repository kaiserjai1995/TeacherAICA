...
public class LecturePositiveIntegerExponentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView webvw = (WebView) rootView.findViewById(R.id.webvw_lecture_positive_integer_exponents);
        ...
        String path = Uri.parse("file:///android_asset/lectures/positive_integer_exponents.html").toString();
        webvw.loadUrl(path);
