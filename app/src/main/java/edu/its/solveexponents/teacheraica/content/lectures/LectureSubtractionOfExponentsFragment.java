...
public class LectureSubtractionOfExponentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Subtraction of Exponents");

        webvw_1 = (WebView) rootView.findViewById(R.id.webvw_lecture_subtraction_of_exponents_1);
        webvw_2 = (WebView) rootView.findViewById(R.id.webvw_lecture_subtraction_of_exponents_2);
        ...
        webvw_1.loadUrl(Uri.parse("file:///android_asset/lectures/subtraction_of_exponents/subtraction_of_exponents_1.html").toString());
        ...
        lecture_next_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                webvw_2.loadUrl(Uri.parse("file:///android_asset/lectures/subtraction_of_exponents/subtraction_of_exponents_2.html").toString());
