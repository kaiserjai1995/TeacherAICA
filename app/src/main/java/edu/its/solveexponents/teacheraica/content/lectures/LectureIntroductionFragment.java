...
public class LectureIntroductionFragment extends Fragment {

    public LectureIntroductionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_lecture_introduction, container, false);
        getActivity().setTitle("Introduction");

        webvw_1 = (WebView) rootView.findViewById(R.id.webvw_lecture_introduction_1);
        webvw_2 = (WebView) rootView.findViewById(R.id.webvw_lecture_introduction_2);
        webvw_3 = (WebView) rootView.findViewById(R.id.webvw_lecture_introduction_3);
        webvw_4 = (WebView) rootView.findViewById(R.id.webvw_lecture_introduction_4);
        ...
        webvw_1.loadUrl(Uri.parse("file:///android_asset/lectures/introduction/introduction_1.html").toString());
        ...
        lecture_next_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                webvw_2.loadUrl(Uri.parse("file:///android_asset/lectures/introduction/introduction_2.html").toString());
        ...
        lecture_next_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                webvw_3.loadUrl(Uri.parse("file:///android_asset/lectures/introduction/introduction_3.html").toString());
        ...
        lecture_next_3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                webvw_4.loadUrl(Uri.parse("file:///android_asset/lectures/introduction/introduction_4.html").toString());
