...
import static edu.its.solveexponents.teacheraica.R.id.lecture_interaction_6;
...
public class LectureAdditionOfExponentsWithTheSameBasesFragment extends Fragment {

    public LectureAdditionOfExponentsWithTheSameBasesFragment() {
        // Required empty public constructor
    }

    String hint = "Addition of Exponents with the Same Bases";

    WebView webvw_1, webvw_2, webvw_3, webvw_4, webvw_5, webvw_6;
    String question_1 = "3^2 * 3^1", question_2 = "a^2 * a^3", question_3 = "y^2 * y^3 * y^2",
            question_4 = "2^1 * 2^3 * 2^2";
    String question_string_1, question_string_2, question_string_3, question_string_4;
    MathView math_question_1, math_question_2, math_question_3, math_question_4;
    ...
    FancyButton lecture_next_1, lecture_next_2, lecture_next_3, lecture_next_4, lecture_next_5, lecture_next_6,
            lecture_next_7, lecture_next_8, lecture_next_9, lecture_next_10;
    RelativeLayout lecture_question_1, lecture_question_2, lecture_question_3, lecture_question_4;
    RelativeLayout lecture_interaction_1, lecture_interaction_2, lecture_interaction_3, lecture_interaction_4,
            lecture_interaction_5, lecture_interaction_6;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_lecture_addition_of_exponents_with_the_same_bases, container, false);
        getActivity().setTitle("Addition of Exponents with the Same Bases");
        ...
        webvw_1 = (WebView) rootView.findViewById(R.id.webvw_lecture_addition_of_exponents_with_the_same_bases_1);
        webvw_2 = (WebView) rootView.findViewById(R.id.webvw_lecture_addition_of_exponents_with_the_same_bases_2);
        webvw_3 = (WebView) rootView.findViewById(R.id.webvw_lecture_addition_of_exponents_with_the_same_bases_3);
        webvw_4 = (WebView) rootView.findViewById(R.id.webvw_lecture_addition_of_exponents_with_the_same_bases_4);
        webvw_5 = (WebView) rootView.findViewById(R.id.webvw_lecture_addition_of_exponents_with_the_same_bases_5);
        webvw_6 = (WebView) rootView.findViewById(R.id.webvw_lecture_addition_of_exponents_with_the_same_bases_6);
        ...
        webvw_1.loadUrl(Uri.parse("file:///android_asset/lectures/addition_of_exponents_with_the_same_bases/addition_of_exponents_with_the_same_bases_1.html").toString());
        ...
        lecture_next_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                webvw_2.loadUrl(Uri.parse("file:///android_asset/lectures/addition_of_exponents_with_the_same_bases/addition_of_exponents_with_the_same_bases_2.html").toString());
        ...
        lecture_next_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                webvw_3.loadUrl(Uri.parse("file:///android_asset/lectures/addition_of_exponents_with_the_same_bases/addition_of_exponents_with_the_same_bases_3.html").toString());
        ...
        lecture_next_3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                webvw_4.loadUrl(Uri.parse("file:///android_asset/lectures/addition_of_exponents_with_the_same_bases/addition_of_exponents_with_the_same_bases_4.html").toString());
        ...
        lecture_next_4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                webvw_5.loadUrl(Uri.parse("file:///android_asset/lectures/addition_of_exponents_with_the_same_bases/addition_of_exponents_with_the_same_bases_5.html").toString());
        ...
        lecture_next_6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (LoginActivity.teacheraicadb.checkProblemIfExistsLecture(question_2)) {
                    ...
                    lecture_next_6.setVisibility(View.GONE);
                    lecture_next_7.setVisibility(View.VISIBLE);
                } else {
        ...
        lecture_next_8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (LoginActivity.teacheraicadb.checkProblemIfExistsLecture(question_4)) {
                    ...
                    lecture_next_7.setVisibility(View.GONE);
                    lecture_next_8.setVisibility(View.GONE);
                    lecture_next_9.setVisibility(View.VISIBLE);
                } else {
        ...
        lecture_next_9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                webvw_6.loadUrl(Uri.parse("file:///android_asset/lectures/addition_of_exponents_with_the_same_bases/addition_of_exponents_with_the_same_bases_6.html").toString());
        ...
        new LovelyCustomDialog(getContext())
                ...
                .configureView(new LovelyCustomDialog.ViewConfigurator() {
                    ...
                    public void configureView(View v) {
                        ...
                        util = new ExprEvaluator();
                        engine = util.getEvalEngine();
                        engine.setStepListener(new LectureAdditionOfExponentsWithTheSameBasesFragment.StepListener());
                        MathMLUtilities mathUtil = new MathMLUtilities(engine, false, false);
                        StringWriter stw = new StringWriter();
