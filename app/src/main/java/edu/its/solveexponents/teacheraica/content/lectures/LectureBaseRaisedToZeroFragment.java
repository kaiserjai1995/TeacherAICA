...
public class LectureBaseRaisedToZeroFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Base Raised to Zero");

        webvw_1 = (WebView) rootView.findViewById(R.id.webvw_lecture_base_raised_to_zero_1);
        webvw_2 = (WebView) rootView.findViewById(R.id.webvw_lecture_base_raised_to_zero_2);
        ...
        webvw_1.loadUrl(Uri.parse("file:///android_asset/lectures/base_raised_to_zero/base_raised_to_zero_1.html").toString());
        ...
        lecture_next_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                webvw_2.loadUrl(Uri.parse("file:///android_asset/lectures/base_raised_to_zero/base_raised_to_zero_2.html").toString());
